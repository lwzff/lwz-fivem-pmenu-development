...
function PMenu:resetMenu()
	...
	self.Base = {
		...
		Title = GM and GM.user and GM.user.name or "Inventaire",
		Checkbox = { Icon = { [2] = {"commonmenu", "shop_box_blank"}, [1] = {"commonmenu", "shop_box_tickb"} } }
	}
	self.Menu = {}
	self.Events = {}
	self.tempData = {}
...
function PMenu:ProcessControl()
	...
	local boolUP, boolDOWN, boolRIGHT, boolLEFT = IsControlPressed(1, 27), IsControlPressed(1, 173), IsControlPressed(1, 175), IsControlPressed(1, 174)
